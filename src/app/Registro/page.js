...
export default function Registro() {
  return (
    <div className={`min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-br from-pink-200 via-pink-50 to-green-200 p-6 relative overflow-hidden ${poppins.className}`}>
      ...
      />
      {/* Tarjeta de Registro */}
      <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-8 md:p-12 w-full max-w-3xl shadow-2xl z-10 mt-20 md:mt-0">
        {/* Encabezado */}
        <div className="flex flex-col items-center mb-8 border-b border-gray-200 pb-6">
          ...
          <h2 className={`${montserrat.className} text-3xl md:text-4xl font-black text-black text-center`}>
            Identidad
          </h2>
        ...
        <form className="flex flex-col gap-6 text-left">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="w-full">
              <label className="block text-gray-800 font-semibold mb-2 ml-2">Nombres:</label>
              <div className="flex items-center bg-[#F4EBE0] rounded-full px-4 py-3 border border-transparent focus-within:border-teal-600 transition-all">
                ...
                <input type="text" placeholder="Ej. Ana Laura" className="bg-transparent outline-none w-full text-gray-800 placeholder-gray-500 font-medium" />
              </div>
            </div>
            {/* Input Apellidos */}
            <div className="w-full">
              <label className="block text-gray-800 font-semibold mb-2 ml-2">Apellidos:</label>
              <div className="flex items-center bg-[#F4EBE0] rounded-full px-4 py-3 border border-transparent focus-within:border-teal-600 transition-all">
                <svg className="w-5 h-5 text-gray-600 mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                </svg>
                <input type="text" placeholder="Ej. De la O Escobedo" className="bg-transparent outline-none w-full text-gray-800 placeholder-gray-500 font-medium" />
              </div>
            </div>
            {/* Input Correo */}
            <div className="w-full">
              <label className="block text-gray-800 font-semibold mb-2 ml-2">Correo Electrónico:</label>
              <div className="flex items-center bg-[#F4EBE0] rounded-full px-4 py-3 border border-transparent focus-within:border-teal-600 transition-all">
                <svg className="w-5 h-5 text-gray-600 mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                </svg>
                <input type="email" placeholder="AnaLau27@gmail.com" className="bg-transparent outline-none w-full text-gray-800 placeholder-gray-500 font-medium" />
              </div>
            </div>
            {/* Input Contraseña */}
            <div className="w-full">
              ...
              <div className="flex items-center bg-[#F4EBE0] rounded-full px-4 py-3 border border-transparent focus-within:border-teal-600 transition-all">
                ...
                <input type="password" placeholder="••••••••••••" className="bg-transparent outline-none w-full text-gray-800 placeholder-gray-500 tracking-widest" />
              </div>
            </div>
          </div>
          {/* Botón Continuar */}
          <div className="mt-8">
            <Link href="/Validacion" className="w-full flex justify-center bg-teal-700 hover:bg-teal-800 text-white font-bold text-xl py-4 rounded-full transition-all duration-300 shadow-md hover:shadow-xl hover:-translate-y-1">
              Continuar
            </Link>
          </div>
        </form>
